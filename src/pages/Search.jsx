  ...
  return (
    <div className="pt-20 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        {/* Search input */}
        <div className="flex items-center gap-2 h-11 px-4 bg-gray-50 border border-gray-200 rounded-lg focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-400/20 transition">
          <RiSearchLine fontSize={20} className="text-gray-400 flex-shrink-0" />
          <input
            ref={inputRef}
            type="text"
            value={query}
            ...
            className="w-full h-full bg-transparent focus:outline-none text-gray-900 placeholder:text-gray-400"
          />
        </div>
