                ...
                <div
                    ...
                    <div className="min-w-full min-h-140 rounded-md overflow-hidden">
                        ...
                        <Link to={`/pins/1`} className="w-full h-full">
                            <img src={"https://source.unsplash.com/featured"} className="rounded-md object-cover w-full h-full" alt={`picture`}/>
                        </Link>
                    </div>
                    {/*Pin-creator profile*/}
                    <Link to={`/user/profile/1`} className="w-full ml-1 max-h-8 flex gap-1.5 items-center justify-start">
                        <img src={"https://source.unsplash.com/featured"} className="w-7 h-7 object-contain rounded-full object-contain transition-all"
                             alt={` profile`}/>
                        <div
                            className="w-full max-w-full flex flex-col items-start justify-start font-light text-xs capitalize pr-2 truncate">
                            <h3 className={"truncate max-w-full pr-2 tracking-wide"}>Judy Doe</h3>
                            <small className="font-fira tracking-wider text-color-font-secondary">Writer</small>
                        </div>
                    </Link>
                </div>
            </div>
